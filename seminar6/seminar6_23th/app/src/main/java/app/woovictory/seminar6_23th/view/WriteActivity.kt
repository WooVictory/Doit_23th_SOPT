...
class WriteActivity : AppCompatActivity(), View.OnClickListener {
    override fun onClick(v: View?) {
        when (v!!) {
            ...
            btn_write_act_complete -> getWriteBoardResponse()
        }
    }
    ...
    private fun init() {
        btn_write_act_show_album.setOnClickListener(this)
        btn_write_act_complete.setOnClickListener(this)
    }
        ...
        if (requestCode == REQUEST_CODE_SELECT_IMAGE) {
            if (resultCode == Activity.RESULT_OK) {
                data?.let {
                    ...
                    Glide.with(this@WriteActivity).load(seletedPictureUri).thumbnail(0.1f)
    ...
    private fun getWriteBoardResponse() {
        ...
        if (input_title.isNotEmpty() && input_contents.isNotEmpty()) {
            ...
            val token =
                "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJEb0lUU09QVCIsInVzZXJfaWR4Ijo2N30.WLzMdA7k0bWIGUI_OGIu3FVmS_e8aNxLqPbmqzzayeY"
            ...
            postWriteBoardResponse.enqueue(object : Callback<PostBoardWriteResponse> {
                ...
                override fun onResponse(
                    call: Call<PostBoardWriteResponse>,
                    response: Response<PostBoardWriteResponse>
                ) {
